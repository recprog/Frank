...
<?php if ('open' == $post->comment_status) : ?>
		...
		$comment_field = '<div id="comment-form-content"><label for="comment">' . _x( 'Comment', 'noun' ) . '</label><textarea id="comment-form-textarea" placeholder="Your Comment" name="comment" aria-required="true"></textarea></div>';
