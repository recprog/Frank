...
$PHPTHUMB_CONFIG['cache_maxage'] = 86400 * 5;        // delete cached thumbnails that haven't been accessed in more than [30 days] (value is maximum time since last access in seconds to avoid deletion)

//$PHPTHUMB_CONFIG['cache_maxsize'] = null;           // never delete cached thumbnails based on byte size of cache directory
$PHPTHUMB_CONFIG['cache_maxsize'] = 4 * 1024 * 1024; // delete least-recently-accessed cached thumbnails when more than [10MB] of cached files are present (value is maximum bytesize of all cached files)
...
$PHPTHUMB_CONFIG['error_bgcolor']               = '333333'; // background color of error message images
$PHPTHUMB_CONFIG['error_textcolor']             = 'cccccc'; // color of text in error messages
